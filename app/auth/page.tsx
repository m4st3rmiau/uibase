      ...
      <Card className="w-full max-w-sm shadow-none border-none bg-transparent">
        <div className="flex flex-col items-center gap-5">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 dark:text-black"
          >
            <svg
              className="h-5 w-5"
